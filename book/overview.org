...
#+begin_src asymptote :noweb eval :file overview-c-process.png
<<lib>>

init_canvas(540, 100);

Box code = Box((50, 50), (80, 60), "C code");
Box exe = Box((260, 50), (140, 60), "Execuable file");
Box machine = Box((480, 50), (80, 60), "Machine");

code.connect(exe, E, W, "compile");
exe.connect(machine, E, W, "executed");
#+end_src
...
#+begin_src asymptote :noweb eval :file overview-lua-process.png
<<lib>>

init_canvas(500, 300);

Box code = Box((60, 200), (80, 60), "Lua code");
Box proto = Box((240, 200), (80, 60), "Proto");
Box vm = Box((440, 200), (80, 60), "VM");
Box bfile = Box((240, 80), (120, 60), "Binary file");

code.connect(proto, E, W, "compile");
proto.connect(vm, E, W, "executed");
proto.connect(bfile, S + W/2, N + W/3, "dump", W);
bfile.connect(proto, N + E/3, S + E/2, "undump", E);
#+end_src
