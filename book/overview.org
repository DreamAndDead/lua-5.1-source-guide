...
#+begin_src ditaa :file overview-execution.png

+----------+             +----------+             +----------+
|          | compile     |          |  executed   |          |
| C code   +------------>| execuable+------------>| Machine  |
|          |             | file     |             |          |
+----------+             +----------+             +----------+
...
#+RESULTS:
[[file:overview-execution.png]]

C 代码通过编译过程，生成可执行文件；可执行文件被机器执行，达成 C 代码描述的语义。

#+begin_src ditaa :file overview-lua.png
